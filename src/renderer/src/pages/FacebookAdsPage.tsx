...
function CampaignCard({ campaign, onToggleStatus, onBudgetSave }: CampaignCardProps) {
  ...
  return (
    <div className={`rounded-xl border border-white/10 border-l-4 bg-white/5 p-5 ${health.accent}`}>
      ...
      {/* Metrics row */}
      <div className="mt-4 grid grid-cols-5 gap-4 border-t border-white/5 pt-4">
        <div>
        ...
        <div>
          <p className="text-[10px] font-medium tracking-wide text-zinc-500 uppercase">Conv.</p>
          <p className="text-sm font-semibold text-white">{campaign.conversions}</p>
        </div>
        <div>
          <p className="text-[10px] font-medium tracking-wide text-zinc-500 uppercase">ROAS</p>
    ...
    return (
      <main className="flex flex-1 flex-col items-center justify-center gap-4 px-6">
        <div className="flex max-w-sm flex-col items-center gap-4 rounded-2xl border border-white/10 bg-white/5 p-8 text-center">
          <h2 className="text-lg font-bold text-white">Connect Facebook Ads</h2>
          ...
          <div className="flex items-start justify-between">
            <div>
              <h2 className="text-xl font-bold tracking-tight text-white uppercase sm:text-2xl">
                Facebook <span className="text-teal-400">Ads</span>
              </h2>
