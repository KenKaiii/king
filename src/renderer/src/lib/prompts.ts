...
const rawPrompts: Omit<Prompt, 'category'>[] = [
  ...
  // Beauty / Cosmetics Social Media
  {
    ...
    prompt: `Photorealistic close-up of a manicured hand holding the product at a slight angle against a soft pastel gradient background. Natural soft lighting, clean nails with neutral polish, minimal gold jewelry, product label readable, shallow depth of field, beauty editorial style, 8K resolution.`,
  },
  {
    ...
    prompt: `Ultra-realistic overhead flat-lay of the product arranged with complementary skincare items on a white marble or terrazzo surface. Fresh cut flowers, tiny water droplets scattered on surface, soft diffused morning light from window, beauty magazine editorial style, clean composition, color-accurate, 8K resolution.`,
  },
  {
    ...
    prompt: `Cinematic product shot of the product — a minimalist tube or bottle floating in perfectly still water, gentle ripples radiating outward, soft reflection visible below, muted pastel tones, serene spa-like atmosphere, diffused overhead lighting, 8K resolution, premium beauty advertising.`,
  },
  {
    id: 'beauty-glow-shot',
    title: 'Beauty Glow',
    ...
    prompt: `Photorealistic beauty product shot of the product with a soft radiant glow emanating from behind, dewy moisture texture on surface, fresh botanical elements — eucalyptus sprigs, flower petals — scattered around, light airy background, beauty editorial lighting with large softbox, 8K resolution, ultra-sharp focus.`,
  },
  ...
  },
  {
    ...
    prompt: `Product rendered in fluid chrome with dynamic glass refraction and prismatic chromatic aberration. Pure black void background, controlled specular highlights creating rainbow caustics, Y2K futuristic tech aesthetic, high-fashion editorial product photography, ultra-sharp focus, 8K resolution, premium commercial style.`,
  },
  {
  ...
  },
  {
    ...
    prompt: `Hyperrealistic luxury product photography of the product — a transparent cosmetic jar with whipped scrub erupting upward from the open lid in a dynamic burst. Lid suspended above the jar, surrounded by fresh fruit cubes, halved tropical fruits, and golden droplets frozen in motion. Centered macro view, cinematic studio lighting from above, glowing highlights, shallow depth of field, warm nude gradient background, premium skincare advertising, 8K resolution.`,
  },
  {
    ...
    prompt: `Photorealistic commercial beauty shot of the product tube tightly squeezed between two large glossy pink balloon-like spheres. Balloons press inward creating a playful compression effect around the tube. Product centered vertically, front label sharp and readable. Ultra-clean studio beauty lighting, smooth highlights, soft specular reflections on balloons. Soft pastel pink gradient background, minimal and distraction-free. Modern minimalistic premium skincare advertising, playful composition, luxury beauty campaign energy, 8K resolution.`,
  },
  {
  ...
  },
  {
    ...
    prompt: `Photorealistic beauty product shot showing the product — foundation swatches in a gradient of shades applied as clean parallel stripes on a forearm with natural skin texture. Soft diffused overhead light, neutral background, true-to-life color accuracy for each shade, sharp focus on swatch edges blending into skin, 8K resolution, inclusive beauty advertising style.`,
  },
  {
    ...
    prompt: `Hyper-realistic overhead beauty shot of the product — an open eyeshadow palette with vibrant pressed powders, surrounded by artistic scattered loose pigment dust in matching colors. Clean white surface, dramatic directional light casting long soft shadows, color-accurate shimmer and matte finishes visible, some pans showing finger-swipe texture, editorial beauty photography, 8K resolution.`,
  },
  {
  ...
  },
  {
    ...
    prompt: `High-speed beauty photography of the product — a makeup brush mid-tap releasing a vibrant burst of colored powder into the air. Powder particles frozen in motion forming an expressive cloud, dark background isolating the color explosion, dramatic side lighting catching every particle, sharp focus on brush bristles, 8K resolution, creative beauty editorial.`,
  },
  {
    id: 'lip-gloss-drip',
    ...
    image: lipGlossDrip,
    prompt: `Ultra-realistic macro beauty shot of the product — a lip gloss applicator pulled from the tube with a thick, glossy, honey-like drip of product stretching downward. Translucent shimmer visible in the formula, soft pink gradient background, clean studio lighting with specular highlights on the gloss surface, extreme close-up detail, 8K resolution, luxury beauty advertising.`,
  },
  ...
  },
  {
    ...
    prompt: `Ultra-realistic macro beauty photograph of the product — a body oil bottle with golden amber oil cascading down its surface in a slow viscous pour. Warm backlight catching the translucent oil, creating a glowing honey-like effect. Soft bokeh background in warm neutral tones, specular highlights on every oil ripple, extreme texture detail, 8K resolution, luxury body care editorial.`,
  },
  {
    id: 'bath-bomb-fizz',
  ...
  // Beauty — Nail & Accessories
  {
    ...
    prompt: `Ultra-macro beauty photograph of the product — a nail polish bottle with the brush pulled out, thick glossy lacquer dripping from the bristles in a single viscous strand. Rich saturated color, clean studio lighting with specular highlight along the drip, dark elegant background, extreme close-up showing pigment density and shine, 8K resolution, luxury nail brand advertising.`,
  },
  {
  ...
  },
  {
    ...
    prompt: `Ultra-realistic beauty product photograph of the product surrounded by fresh citrus slices — lemon, orange, grapefruit — with juice splashes frozen mid-air. Bright clean white background, vivid natural colors, tiny water droplets on product surface, fresh and energizing composition, overhead studio lighting, ultra-sharp focus, 8K resolution, vibrant beauty advertising.`,
  },
  {
  ...
  },
  {
    ...
    prompt: `Photorealistic overhead beauty shot of the product floating in milky rose-tinted bath water, surrounded by scattered fresh rose petals in pink and cream tones. Soft natural light from a window, gentle ripples in the water surface, product label visible and sharp, serene romantic spa atmosphere, warm pastel color palette, 8K resolution, luxury beauty lifestyle editorial.`,
  },
  {
